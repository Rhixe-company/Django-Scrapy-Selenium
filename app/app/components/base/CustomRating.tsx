...
export default function CustomRating({ rating }: any) {
  return (
    <div
    ...
    >
      <div className={rating >= 5.5 ? `rr--box rr--on` : `rr--box rr--off`}>
        <svg
          aria-hidden="true"
          className="rr--svg"
      ...
      <div className={rating >= 6.5 ? `rr--box rr--on` : `rr--box rr--off`}>
        <svg
          aria-hidden="true"
          className="rr--svg"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className={rating >= 7.5 ? `rr--box rr--on` : `rr--box rr--off`}>
        <svg
          aria-hidden="true"
          className="rr--svg"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className={rating >= 8.5 ? `rr--box rr--on` : `rr--box rr--off`}>
        <svg
          aria-hidden="true"
          className="rr--svg"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className={rating >= 9.5 ? `rr--box rr--on` : `rr--box rr--off`}>
        <svg
          aria-hidden="true"
          className="rr--svg"
          xmlns="http://www.w3.org/2000/svg"
