...
class User(AbstractUser):
    ...
    def get_absolute_url(self) -> str:
        return reverse("users:user_detail", kwargs={"id": self.id})  # type: ignore  # noqa: PGH003

    def get_edit_url(self) -> str:
        return reverse("users:update_user", kwargs={"id": self.id})  # type: ignore  # noqa: PGH003

    def get_hx_url(self) -> str:
        return reverse("users:hx_user_detail", kwargs={"id": self.id})  # type: ignore  # noqa: PGH003

    def get_delete_url(self) -> str:
        return reverse("users:delete_user", kwargs={"id": self.id})  # type: ignore  # noqa: PGH003

    def get_user_comics_children(self):
        return self.comicuser.all()  # type: ignore  # noqa: PGH003

    def get_user_comments_children(self):
        return self.usercomments.all()  # type: ignore  # noqa: PGH003
