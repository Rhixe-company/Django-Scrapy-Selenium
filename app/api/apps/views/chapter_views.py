...
def chapter_list_view(request):
    ...
    qs = Chapter.objects.prefetch_related("chapterimages").select_related("comic").all()
...
def chapter_update_view(request, slug=None):
    ...
    return render(
        request,
        template_name,
        {"form": form, "object": obj, "new_chapter_image_url": new_chapter_image_url},
    )
...
def chapter_delete_view(request, slug=None):
    ...
    try:
        obj = (
            Chapter.objects.prefetch_related("chapterimages")
