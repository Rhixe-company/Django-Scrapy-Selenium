          ...
          <div className="space-y-7">
                ...
                >
                  ...
                  <div className="col-span-12 sm:col-span-9 pt-10">
                    <div className="text-center sm:text-left">
                      <span className="text-xl font-bold">{comic.title}</span>
                    </div>
                    <div className="flex items-center justify-center sm:justify-start flex-wrap gap-1 py-4">
                      <Link
                        href={`https://www.facebook.com/sharer/sharer.php?u=/comic/${comic.slug}&amp;t=${comic.title}`}
                        target="_blank"
                      ...
                      <Link
                        href={`https://www.twitter.com/intent/tweet?url=/comic/${comic.slug}&amp;text=${comic.title}`}
                        target="_blank"
                      ...
                      <Link
                        href={`whatsapp://send/?text=${comic.title}%20/comic/${comic.slug}/`}
                        target="_blank"
                      ...
                      <Link
                        href={`https://pinterest.com/pin/create/button/?url=/comic/${comic.slug}&amp;media=${comic.images[0].link}&amp;description=${comic.title}`}
                        target="_blank"
                ...
                <div className="border-t-[1px] border-t-[#A2A2A2]/20 py-4 px-5">
                  <h3 className="text-[#D9D9D9] font-medium text-xs">
                    ...
                    <span className="text-[#A2A2A2] font-normal">
                      read {comic.title}, {comic.title} english, {comic.title}
                      eng, download {comic.title} eng, {comic.title} online
                    </span>
                  </h3>
                </div>
              </div>
            ...
            <div className="bg-[#222222]">
              ...
              <div className="grid grid-cols-2 px-4 py-4 gap-2.5">
                <Link
                  href={`/comic/${comic.slug}/chapter/${comic.first_chapter.slug}`}
                >
                ...
                <Link
                  href={`/comic/${comic.slug}/chapter/${comic.last_chapter.slug}`}
                >
                  <div className="flex flex-col items-center justify-center py-4 rounded-sm bg-themecolor hover:bg-[#343434] transition-all duration-300 cursor-pointer text-white">
              ...
              <div>
                ...
                <div className="pl-4 pr-2 pb-4 overflow-y-auto scrollbar-thumb-themecolor scrollbar-track-transparent scrollbar-thin mr-3 max-h-[20rem] space-y-2.5">
                  {comic.chapters?.map((chapter) => (
                    ...
                    >
                      <Link
                        href={`/comic/${comic.slug}/chapter/${chapter.slug}`}
                      >
                        ...
                        <h3 className="text-sm text-white font-medium flex flex-row ` ${shouldHighlight(chapter.id) ? &#39;&#39; : &#39;text-themecolor&#39;}">
                          {chapter.name}
                          {chapter.title && (
                            <span className="pl-1">{chapter.title}</span>
                          )}
