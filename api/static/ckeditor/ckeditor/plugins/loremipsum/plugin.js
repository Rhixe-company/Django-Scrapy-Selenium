      ...
      case LOREM_TEXT_TYPE.PARAGRAPH:
        ...
        for (var i = 0; i < count; i++) {
          ...
          paragraphsArray.push(
            "<p>" + generateLoremText(Math.floor(Math.random() * 10 + 10), LOREM_TEXT_TYPE.SENTENCE) + "</p>",
          );
        }
      ...
      editor.ui.addRichCombo("Loremipsum", {
        ...
        init: function () {
          ...
          for (var paragraphOption in paragraphOptionsList) {
            this.add(
              paragraphOptionsList[paragraphOption][0],
              paragraphOptionsList[paragraphOption][1],
              paragraphOptionsList[paragraphOption][2],
            );
          }
          ...
          for (var sentenceOption in sentenceOptionsList) {
            this.add(
              sentenceOptionsList[sentenceOption][0],
              sentenceOptionsList[sentenceOption][1],
              sentenceOptionsList[sentenceOption][2],
            );
          }
