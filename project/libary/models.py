...
from project.libary.managers import ChapterManager
from project.libary.managers import ComicManager
...
class ComicImage(models.Model):
    ...
    def __str__(self):
        return f"Image {self.comic_image_id} Comic {self.comic.title}"
...
class UserItem(models.Model):
    ...
    def __str__(self):
        return f"Order {self.order} Comic {self.comic.title} by {self.user.email}"
...
class ChapterImage(models.Model):
    ...
    def __str__(self):
        return f"Image {self.chapter_image_id} Comic {self.comic.title} Chapter {self.chapter.name}"  # noqa: E501
